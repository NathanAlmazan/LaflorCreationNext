        ...
        <>
            <Formik
                ...
                onSubmit={async (values, { setErrors, setStatus, setSubmitting }) => {
                    createUserWithEmailAndPassword(firebaseAuth, values.email, values.password).then((user) => {
                        createClient({
                            variables: { client: {
                                accountUid: user.user.uid,
                                clientContact: "63" + values.contact,
                            ...
                            <Grid item xs={12}>
                                ...
                                <FormControl fullWidth sx={{ mt: 2 }}>
                                    <Grid container spacing={2} alignItems="center">
                                        <Grid item>
                                            <Box sx={{ bgcolor: level ? level.color : '', width: 85, height: 8, borderRadius: '7px' }} />
                                        </Grid>
                                        <Grid item>
